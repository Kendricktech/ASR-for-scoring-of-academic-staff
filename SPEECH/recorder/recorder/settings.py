...
SECRET_KEY = 'django-insecure-e(u)z)fcf(9e#p06ib6!*)77fp%@s^v^sv@ojx!udm3wij45hw'
...
Q_CLUSTER = {
    ...
    'recycle': 500,  # Restart worker after processing 500 tasks
    'timeout': 60,  # Task timeout in seconds
    'django_redis': 'default',  # Use Redis if available, or 'default' for database
    'ack_failures': True,
